...
import SupportService from '../../../assets/supportService.png'
import { useTranslation } from "react-i18next";
const SuppportService = () => {
  ...
  return (
    ...
    <img src={Head} className="w-64 mx-auto" alt="" />
      <h1 className="text-3xl font-serif text-gray-800 mb-4">
        {t("navbar.services.supportService.header")}
      </h1>
      <h3 className="text-gray-800 text-lg font-thin mb-8">
        {t("navbar.services.supportService.header1")}
      </h3>
      <div className="flex flex-col md:flex-row w-full gap-8">
        ...
        <div className="md:w-1/2 flex flex-col justify-center items-center">
          <h1 className="text-3xl font-bold mb-4 mr-12">{t("navbar.services.supportService.header")}</h1>
          <h1 className="font-light text-gray-600 text-base mb-4 md:w-3/4 md:text-left">
            {t("navbar.services.supportService.paragraph1")}
          </h1>
          <h1 className="font-light text-gray-600 text-base mb-4 md:w-3/4 md:text-left">
            {t("navbar.services.supportService.paragraph2")}
          </h1>
        </div>
      </div>
    </div>
