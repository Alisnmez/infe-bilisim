...
const AboutUs = () => {
  ...
  return (
    <>
      ...
      <div className="h-full lg:mt-60 mt-80 z-30 px-20 lg:px-80 bg-gray-100">
        <div className="py-20">
        ...
        <h1 className="text-2xl font-bold text-gray-700 mb-4">{t("aboutUs.header1")}</h1>
          <h1>
            {t("aboutUs.paragraph1")}
          </h1>
          <h1 className="text-2xl font-bold text-gray-700 mt-20 mb-4">{t("aboutUs.header2")}</h1>
          <h1>
          {t("aboutUs.paragraph2")}

          </h1>
          <h1 className="text-2xl font-bold text-gray-700 mt-20 mb-4">{t("aboutUs.header3")}</h1>
          <h1>
